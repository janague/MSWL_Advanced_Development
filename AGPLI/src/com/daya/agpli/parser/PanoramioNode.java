...
public class PanoramioNode implements Parcelable {
	...
	public static final Parcelable.Creator<PanoramioNode> CREATOR = new Parcelable.Creator<PanoramioNode>() {
	...
	public PanoramioNode(Parcel in) {
		...
		if (byteStream.size() > 0) {
			...
			mPhotoThumb = BitmapFactory.decodeByteArray(bitmapBytes, 0,
					bitmapBytes.length);
		}
